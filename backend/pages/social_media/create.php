                            ...
                            <div class="card-body">
                                <form action="../../actions/social_media/store.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="judul" class="form-control" id="judulInput" placeholder="Masukan judul.." required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="link" class="form-control" id="linkInput" placeholder="Masukan link sosial media...." required>
                                    </div>
