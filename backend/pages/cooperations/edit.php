                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                ?>
                                <form action="../../actions/cooperations/update.php?id=<?= $cooperations->id ?>" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="link" class="form-control" id="linkInput"
                                            placeholder="Masukan link kerja sama...." value="<?= $cooperations->link ?>" required>
                                    </div>
